...
app.get('/static', express.static('./server/assets')); // Replaces the route to the folder holding the images (routes files) with '/static'
...
const title = 'MERN E-commerce Backend';
const html = `
<!DOCTYPE html>
<html>
  <head>
